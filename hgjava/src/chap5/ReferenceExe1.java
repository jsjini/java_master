...
public class ReferenceExe1 {
	...
	public static void main(String[] args) {
		...
		// 참조변수: 실제값을 담는게 아니고 실제값의 주소를 담고있다.
...
//		System.out.println(ourFriend.height);
		...
		System.out.println(myFriend == yourFriend); // 주소값을 비교하기 때문에 항상 false
		...
		// 참조타입: 주소값을 변수에 저장
		String name = "신용권"; // new String("신용권"); // 23dbdae34334(주소값)
		String hobby = "독서";
		...
		System.out.println(name == name1); // 문자열은 == -> equals 메소드 활용
